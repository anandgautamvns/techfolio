    ...
    <div className="py-10 max-w-4xl">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          {/* Avatar placeholder */}
          <div className="w-32 h-32 rounded-2xl bg-gradient-to-br from-blue-500/30 to-purple-500/30 border border-slate-700/60 flex items-center justify-center text-5xl">
            👨‍💻
          </div>
        ...
        <div className="space-y-6">
          <div className="p-5 rounded-xl bg-slate-800/40 border border-slate-700/40">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">{about?.story}</p>
          </div>

          <div className="p-5 rounded-xl bg-slate-800/40 border border-slate-700/40">
            <h3 className="text-white font-semibold mb-3">My Mission</h3>
            <p className="text-slate-400 text-sm leading-relaxed">{about?.mission}</p>
          </div>

          <div className="p-5 rounded-xl bg-slate-800/40 border border-slate-700/40">
            <h3 className="text-white font-semibold mb-3">Fun Facts</h3>
            <ul className="space-y-2">
              {(about?.funFacts ?? []).map((fact, i) => (
                <li key={i} className="text-slate-400 text-sm">{fact}</li>
              ))}
            </ul>
          </div>
        </div>
