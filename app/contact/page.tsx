...
export default function ContactPage() {
  ...
  return (
    <div className="py-10 max-w-4xl">
      ...
      <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-8">Contact Me</h1>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/40">
              ...
              <div>
                ...
                <p className="text-slate-900 dark:text-white text-sm">{profile?.email}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/40">
              ...
              <div>
                ...
                <p className="text-slate-900 dark:text-white text-sm">{profile?.phone}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/40">
              ...
              <div>
                ...
                <p className="text-slate-900 dark:text-white text-sm">{profile?.currentLocation}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-4 rounded-xl bg-white dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700/40">
              ...
              <div>
                ...
                <p className="text-slate-900 dark:text-white text-sm">{profile?.location}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 pt-2">
            <a href={profile?.socials.github} target="_blank" rel="noopener noreferrer"
              className="w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:border-slate-300 dark:hover:border-slate-600 transition-all">
              <GithubIcon size={16} />
            </a>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              <label className="text-slate-500 dark:text-slate-400 text-xs mb-1.5 block">Name</label>
              <input
                type="text"
                required
                value={form.name}
                ...
                className="w-full px-4 py-2.5 rounded-xl bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white text-sm placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-blue-500 transition-colors"
              />
            </div>
            <div>
              <label className="text-slate-500 dark:text-slate-400 text-xs mb-1.5 block">Email</label>
              <input
                type="email"
                required
                value={form.email}
          ...
          <div>
            <label className="text-slate-500 dark:text-slate-400 text-xs mb-1.5 block">Subject</label>
            <input
              type="text"
              required
              value={form.subject}
          ...
          <div>
            <label className="text-slate-500 dark:text-slate-400 text-xs mb-1.5 block">Message</label>
            <textarea
              required
              rows={5}
              value={form.message}
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-white dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white text-sm placeholder-slate-400 dark:placeholder-slate-500 focus:outline-none focus:border-blue-500 transition-colors resize-none"
            />
          </div>
